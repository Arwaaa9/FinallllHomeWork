        ...
        <>
            <Flex gap='10'>
                <Box w="30.5em" h="30em" bg="gray.200" mt="5em" id="signUpBox" >
                    <Heading textAlign="center" mt="1em" color="black"> Profile</Heading>
                    <br></br>
                    <Flex justifyContent="center">
                        <Stack spacing={3} w="16em">
                            ...
                            <Button bg="" onClick={() => Navigate('/ProfileUpdate')}> Edit</Button>
                            <Button bg="purple.100" onClick={() => userDelete(localStorage.getItem("id"))}> Delete</Button>
                        </Stack>
                    </Flex>
                </Box>
            </Flex>
